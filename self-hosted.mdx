...
<Accordion icon="server" title="Update & Install NGINX"  defaultOpen>
...
<Accordion icon="file" title="Create NGINX Config" defaultOpen>
...
<Accordion icon="link" title="Enable Site & Reload NGINX" defaultOpen>
...
<Accordion icon="shield-check" title="Install Certbot" defaultOpen>
...
<Accordion icon="lock" title="Generate SSL Certificate" defaultOpen>
