...
[**Weam AI**](https://opensource.weam.ai/) is an open-source collaborative platform that helps teams adopt, customize, and scale workflows without vendor lock-in.
...
<Card title="One-Click Cloud Deployment" icon="rocket" href="/setup/choose-your-setup/deploy-on-cloud">
  Deploy instantly on AWS or DigitalOcean with automated setup scripts.
</Card>

<Card title="Self-Host Weam AI" icon="server" href="/setup/choose-your-setup/on-prem">
  Deploy on your infrastructure for complete control. Requires Docker and basic server administration.
</Card>

<Card title="Local Development" icon="code" href="/setup/choose-your-setup/local-setup">
...
<Card title="View contribution guidelines" icon="github" horizontal href="https://github.com/weam-ai/weam?tab=contributing-ov-file">
</Card>
