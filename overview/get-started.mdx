...
<Card
  title="Self-Hosted Setup (Production)"
  icon="server"
...
| **Self-Hosted** | Custom infrastructure | Linux server, domain, SSL | 20-30 min |
...
<Card
  ...
  icon="gear"
  href="/setup/after-setup-complete/environment-variables"
>
...
<Card
  ...
  icon="key"
  href="/setup/after-setup-complete/credential-setup"
>
...
| Self-Hosted Installation | 20-30 minutes |
...
- Check DNS configuration for self-hosted setups
