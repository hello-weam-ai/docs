...
<Card title="Explore our connections" icon="computer" href="https://docs.weam.ai/connections/slack">
</Card>

<Card title="Explore MCP Workflow" icon="code" href="/essentials/workflows/mcp-workflow.mdx">
</Card>
