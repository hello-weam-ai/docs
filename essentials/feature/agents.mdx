...
Agentss in Weam are specialised AI assistants that can be customised for specific tasks and roles. These agents are designed to handle particular types of interactions based on their configured knowledge base.
...
<iframe width="100%" height="360" src="https://www.youtube.com/embed/J5B2HS8mer8" title="Agents" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen style={{ borderRadius:"0.5rem" }} />
