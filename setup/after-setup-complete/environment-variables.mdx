...
ENV_FILE=.env
ENVIRONMENT_URL=https://dev.yourexampledomain.com
GATEWAY_PORT=9089
```
...
PROFILER_S3_BUCKET=yourcompany-profiler
...
SENDER_EMAIL=noreply@yourexampledomain.com
```
...
NEXT_PUBLIC_PYTHON_API_URL=https://yourexampledomain.com
```
