...
<Accordion title="Python Backend (FastAPI) Variables">

Complete environment variables for the Python FastAPI backend service:

### Application Configuration
```env
Weam AI_ENVIRONMENT=enterprise
STACK_NAME=Weam AI-stack
ENV_FILE=.env
ENVIRONMENT_URL=https://yourexampledomain.com
GATEWAY_PORT=9089
```
...
PROFILER_S3_BUCKET=Weam AI-profiler
AWS_S3_URL=https://s3.amazonaws.com
AWS_CDN_URL=https://yourexampledomain.com
MINIO_PORT=9000
...
NEXT_PUBLIC_COOKIE_NAME=Weam AI-token
...
### Asset Configuration
```env
NEXT_PUBLIC_AWS_S3_URL=https://yourexampledomain.com
NEXT_PUBLIC_IMAGE_DOMAIN=yourexampledomain.com
```
...
NEW_RELIC_APPNAME=Weam AIFrontend
