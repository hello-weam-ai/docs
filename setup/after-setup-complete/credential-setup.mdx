...
<Warning>
**OpenAI API Key Required:** Weam AI requires OpenAI API access for core functionality including RAG processing, web scraping, and content analysis. Configure OpenAI first before adding other providers.
</Warning>
